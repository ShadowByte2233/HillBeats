...
const TRANSLATIONS = {
  de: {
    ...
    'releases.name':          '„Gipfeltreffen" – EP',
    'releases.artist':        'Somniatores',
    'releases.date':          'Veröffentlichung: TBA 2026',
    'releases.desc':          'Vier Tracks zwischen Indie, Electronic und Live-Feeling – aufgenommen in den Hügeln über der Stadt.',
  ...
  en: {
    ...
    'releases.name':          '"Summit Meeting" – EP',
    'releases.artist':        'Somniatores',
    'releases.date':          'Release date: TBA 2026',
    'releases.desc':          'Four tracks blending indie, electronic and live vibes – recorded in the hills above the city.',
    'releases.spotify':       'Spotify',
    'releases.apple':         'Apple Music',
    'releases.youtube':       'YouTube',
